package net.atos.Customer.Swagger;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages ={"net.atos.Customer.controller"})
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2).groupName("SpringBootArchetype")
	        .select()                                  
	        .apis(RequestHandlerSelectors.basePackage("net.atos.Customer.controller"))              
